...
class Wk(BaseCrawler):
    ...
    def parse_data_details(self, *args, **kwargs):
        ...
        # 报名开始时间
        # announcement_start_time: str
        announcement_start_time = str_to_y_m_d_H_M_S(deta_data["info"]["bidingStartTime"])
        auction_info.announcement_start_time = announcement_start_time

        # 报名截止时间
        # announcement_end_time: str
        announcement_end_time = str_to_y_m_d_H_M_S(deta_data["info"]["bidingEndTime"])
    ...
    def action(self, *args, **kwargs):
        minpage = 1
        maxpage = 20  # 写死20
        page_url = 'https://ec.minmetals.com.cn/open/homepage/jps/by-lx-page'
        deta_url = "https://ec.minmetals.com.cn/open/homepage/jps/jpgg"
        ...
        while minpage <= maxpage:
            ...
            for auction_info in auction_infos:
                ...
                auction_info, auction_detial = self.parse_data_details(deta_data=deta_data, auction_info=auction_info)
